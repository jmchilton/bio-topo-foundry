...
- **[[protein-flexibility]]** owns the task the second application is aimed at, and the distinction this experiment falls on the wrong side of: 0.925 is fit and scored on one protein, so no number from a blind benchmark can be set beside it. That page also carries where the line this paper founded now stands against non-topological methods.
