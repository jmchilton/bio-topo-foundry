...
This is a deliberately narrow content and validation slice. It renders the glossary and the one
Package note that has been migrated to typed frontmatter: `petls-pytorch`.
