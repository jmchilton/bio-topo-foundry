...
Extracted **77 of 109** reference-section lines. The verdict counts above describe only the extracted lines.

A wrapped entry counts once per physical line, so this is a lower bound on coverage.

- `content/meta/content-model.md:132`
- `content/meta/content-model.md:133`
- `content/meta/content-model.md:134`
- `content/meta/content-model.md:135`
- `content/meta/content-model.md:136`
- `content/meta/content-model.md:138`
- `content/meta/content-model.md:139`
- `content/meta/content-model.md:140`
- `content/meta/content-model.md:141`
- `content/meta/content-model.md:142`
- `content/meta/content-model.md:143`
- `content/meta/content-model.md:145`
- `content/meta/content-model.md:146`
- `content/meta/content-model.md:147`
...
- `content/papers/tda-tdl-beyond-persistent-homology.md:204`
- `content/papers/tda-tdl-molecular-sciences.md:215`
...
| `content/papers/persistent-spectral-graph.md:23` | Persistent spectral graph | crossref `doi:10.1002/cnm.3376` → doi:10.1002/cnm.3376; openalex `arxiv:1912.04135` → arxiv:1912.04135 | warning: crossref (doi:10.1002/cnm.3376): year differs: described 2019, observed 2020 |
| `content/papers/persistent-spectral-graph.md:158` | Persistent spectral graph | crossref `doi:10.1002/cnm.3376` → doi:10.1002/cnm.3376; openalex `arxiv:1912.04135` → arxiv:1912.04135 | warning: openalex (arxiv:1912.04135): year differs: described 2020, observed 2019 |
...
| `content/papers/tda-tdl-beyond-persistent-homology.md:21` | Topological Data Analysis and Topological Deep Learning Beyond Persistent Homology - A Review | crossref `doi:10.1007/s10462-025-11462-w` → doi:10.1007/s10462-025-11462-w; openalex `arxiv:2507.19504` → arxiv:2507.19504 | — |
| `content/papers/tda-tdl-beyond-persistent-homology.md:206` | Topological Data Analysis and Topological Deep Learning Beyond Persistent Homology - A Review | crossref `doi:10.1007/s10462-025-11462-w` → doi:10.1007/s10462-025-11462-w; openalex `arxiv:2507.19504` → arxiv:2507.19504 | — |
| `content/papers/tda-tdl-beyond-persistent-homology.md:207` | Persistent Laplacians: Properties, Algorithms and Implications | crossref `doi:10.1137/21m1435471` → doi:10.1137/21m1435471 | — |
| `content/papers/tda-tdl-beyond-persistent-homology.md:208` | Evolutionary de Rham-Hodge Method | crossref `doi:10.3934/dcdsb.2020257` → doi:10.3934/dcdsb.2020257 | — |
| `content/papers/tda-tdl-beyond-persistent-homology.md:209` | Persistent de Rham-Hodge Laplacians in Eulerian Representation for Manifold Topological Learning | crossref `doi:10.3934/math.20241333` → doi:10.3934/math.20241333; openalex `arxiv:2408.00220` → arxiv:2408.00220 | — |
| `content/papers/tda-tdl-beyond-persistent-homology.md:210` | Persistent Mayer Homology and Persistent Mayer Laplacian | crossref `doi:10.3934/fods.2024032` → doi:10.3934/fods.2024032; openalex `arxiv:2312.01268` → arxiv:2312.01268 | warning: openalex (arxiv:2312.01268): year differs: described 2024, observed 2023 |
| `content/papers/tda-tdl-beyond-persistent-homology.md:211` | Persistent Interaction Topology in Data Analysis | openalex `arxiv:2404.11799` → arxiv:2404.11799 | — |
| `content/papers/tda-tdl-beyond-persistent-homology.md:212` | Knot Data Analysis Using Multiscale Gauss Link Integral | crossref `doi:10.1073/pnas.2408431121` → doi:10.1073/pnas.2408431121; openalex `arxiv:2311.12834` → arxiv:2311.12834 | warning: openalex (arxiv:2311.12834): year differs: described 2024, observed 2023 |
| `content/papers/tda-tdl-beyond-persistent-homology.md:213` | Manifold Topological Deep Learning for Biomedical Data | openalex `arxiv:2503.00175` → arxiv:2503.00175 | — |
...
| `content/papers/tda-tdl-molecular-sciences.md:23` | A review of topological data analysis and topological deep learning in molecular sciences | crossref `doi:10.1021/acs.jcim.5c02266` → doi:10.1021/acs.jcim.5c02266; openalex `arxiv:2509.16877` → arxiv:2509.16877 | — |
| `content/papers/tda-tdl-molecular-sciences.md:219` | A review of topological data analysis and topological deep learning in molecular sciences | crossref `doi:10.1021/acs.jcim.5c02266` → doi:10.1021/acs.jcim.5c02266; openalex `arxiv:2509.16877` → arxiv:2509.16877 | — |
| `content/papers/tda-tdl-molecular-sciences.md:220` | Persistent homology analysis of protein structure, flexibility, and folding | crossref `doi:10.1002/cnm.2655` → doi:10.1002/cnm.2655 | — |
| `content/papers/tda-tdl-molecular-sciences.md:221` | Analysis and prediction of protein folding energy changes upon mutation by element specific persistent homology | crossref `doi:10.1093/bioinformatics/btx460` → doi:10.1093/bioinformatics/btx460 | — |
| `content/papers/tda-tdl-molecular-sciences.md:222` | TopologyNet: Topology based deep convolutional and multi-task neural networks for biomolecular property predictions | crossref `doi:10.1371/journal.pcbi.1005690` → doi:10.1371/journal.pcbi.1005690 | — |
| `content/papers/tda-tdl-molecular-sciences.md:223` | Representability of algebraic topology for biomolecules in machine learning based scoring and virtual screening | crossref `doi:10.1371/journal.pcbi.1005929` → doi:10.1371/journal.pcbi.1005929 | — |
| `content/papers/tda-tdl-molecular-sciences.md:224` | Integration of element specific persistent homology and machine learning for protein-ligand binding affinity prediction | crossref `doi:10.1002/cnm.2914` → doi:10.1002/cnm.2914 | — |
| `content/papers/tda-tdl-molecular-sciences.md:225` | A topology-based network tree for the prediction of protein-protein binding affinity changes following mutation | crossref `doi:10.1038/s42256-020-0149-6` → doi:10.1038/s42256-020-0149-6 | — |
| `content/papers/tda-tdl-molecular-sciences.md:226` | Persistent spectral graph | crossref `doi:10.1002/cnm.3376` → doi:10.1002/cnm.3376 | — |
| `content/papers/tda-tdl-molecular-sciences.md:227` | Persistent Laplacians: Properties, Algorithms and Implications | crossref `doi:10.1137/21m1435471` → doi:10.1137/21m1435471 | — |
| `content/papers/tda-tdl-molecular-sciences.md:228` | Persistent spectral theory-guided protein engineering | crossref `doi:10.1038/s43588-022-00394-y` → doi:10.1038/s43588-022-00394-y | — |
| `content/papers/tda-tdl-molecular-sciences.md:229` | Omicron BA.2 (B.1.1.529.2): High Potential for Becoming the Next Dominant Variant | crossref `doi:10.1021/acs.jpclett.2c00469` → doi:10.1021/acs.jpclett.2c00469 | — |
| `content/papers/tda-tdl-molecular-sciences.md:230` | Persistent Laplacian projected Omicron BA.4 and BA.5 to become new dominating variants | crossref `doi:10.1016/j.compbiomed.2022.106262` → doi:10.1016/j.compbiomed.2022.106262 | — |
| `content/papers/tda-tdl-molecular-sciences.md:231` | Topological data analysis and topological deep learning beyond persistent homology - a review | openalex `arxiv:2507.19504` → arxiv:2507.19504 | — |
...
| `content/papers/persistent-spectral-graph.md` | 11 | 0 |
...
- Generic/non-scholarly URLs excluded: 50
